        ...
        <div class="card-body">
          ...
          <form class="row g-3" action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12">
              ...
              <input type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" placeholder="Quantity" value="{{old('quantity')}}">
                @error('quantity')
                    <span class="text-danger" role="alert">
                        <p>{{ $message }}</p>
                    </span>
            ...
            <div class="col-6">
              ...
              <input type="number" class="form-control @error('original_price') is-invalid @enderror" name="original_price" placeholder="Original Price" value="{{old('original_price')}}">
            ...
            <div class="col-6">
              ...
              <input type="number" class="form-control @error('selling_price') is-invalid @enderror" name="selling_price" placeholder="selling Price" value="{{old('selling_price')}}">
                @error('selling_price')
                    <span class="text-danger" role="alert">
                        <p>{{ $message }}</p>
                    </span>
